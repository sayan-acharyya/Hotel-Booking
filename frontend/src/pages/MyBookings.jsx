    ...
    <div className='min-h-screen bg-gray-50 py-32'>
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-blue-800 mb-4">My Bookings</h1>
                ...
                <div key={booking._id} className='p-6 hover:bg-gray-50 transition-colors'>
                  <div className='grid grid-cols-1 md:grid-cols-4 gap-6 items-start md:items-center'>
                    ...
                    <div className="space-y-1">
                      ...
                      {/* Payment Status */}
                      <button 
                      onClick={()=>handelPayment(booking._id)}
                      className={`inline-flex cursor-pointer items-center gap-2 px-3 py-1 rounded-full text-md font-medium ${booking.isPaid ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
